...
import styles from "../AddStudentAdmin/AddStudentAdmin.module.css"; // Reuse the same styles
...
export default function EditStudentAdmin() {
  ...
  // Fetch departments (same as AddStudentAdmin)
  ...
  // Fetch the student's data based on studentId
  const fetchStudentData = async () => {
    try {
      ...
      setStudentData(response.data); // Assuming response.data contains the student object
    } catch (error) {
  ...
  useEffect(() => {
    ...
    fetchDepartments();
    fetchStudentData();
  }, [accessToken, studentId, navigate]);

  // Same validation schema as AddStudentAdmin
  ...
  const formik = useFormik({
    ...
    enableReinitialize: true, // Allow reinitialization when studentData changes
  ...
  // Update formik initial values when studentData is fetched
  useEffect(() => {
    if (studentData) {
      formik.setValues({
